...
import 'package:image_finder/core/component/dialog/confirmation_dialog.dart';
import 'package:image_finder/core/component/dialog/loading_dialog.dart';
...
import 'package:image_finder/module/edit_photo/presentation/pages/add_text_layout.dart';
import 'package:image_finder/module/edit_photo/presentation/widget/dragable_widget.dart';
import 'package:image_finder/module/edit_photo/presentation/widget/edit_photo_widget.dart';
import 'package:image_finder/module/edit_photo/presentation/widget/menu_icon_widget.dart';
              ...
              child: MenuIconWidget(
                onTap: () async {
                  final result = await showConfirmationDialog(
                    ...
                    title: "حذف ویرایش ها",
                    desc:
                        "آیا مطمئن هستید که می خواهید خارج شوید؟ تمام ویرایش هایی که انجام داده اید را از دست خواهید داد",
                  );
                      ...
                      final widget = DragableWidget(
                        ...
                        onLongPress: (id) async {
                          final result = await showConfirmationDialog(
                            context,
                            title: "Delete Text ?",
                            desc: "آیا مطمئن هستید که می خواهید خارج شوید؟ تمام ویرایش هایی که انجام داده اید را از دست خواهید دادآیا مطمئن هستید که می خواهید خارج شوید؟ تمام ویرایش هایی که انجام داده اید را از دست خواهید دادwant to Delete this text ?",
                            rightText: "Delete",
                          );
                          if (result == null) return;
